...
struct Command commands[] =
{
		...
		{ "schedPRIRR", "Initialize the Priority RR scheduler by the given number of priorities, CPU quantum and starvation threshold" ,command_sched_init_PRIRR, 3},
...
//*****************************************************************************************//
int command_sched_init_PRIRR(int number_of_arguments, char **arguments)//ms3
{
